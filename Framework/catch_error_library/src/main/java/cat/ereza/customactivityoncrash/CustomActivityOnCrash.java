...
public final class CustomActivityOnCrash {
    ...
    private static Class<? extends Activity> mErrorClass;
    /**
     * Installs CustomActivityOnCrash on the application using the default error activity.
     *
     * @param context Context to use for obtaining the ApplicationContext. Must not be null.
     * @param errorClass Replace default error interface. if he is null,the default Set to DefaultErrorActivity.class
     */
    public static void install(Context context, Class errorClass) {
        try {
            if (context == null) {
                ...
                if(errorClass!=null){
                    ...
                    mErrorClass= DefaultErrorActivity.class;
                }
                    ...
                    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            ...
                            if (errorActivityClass == null) {
                                errorActivityClass = guessErrorActivityClass(application,mErrorClass);
                            }
     ...
     *
     * @param context A valid context. Must not be null.
     * @param mErrorClass Replace default error interface
     * @return The guessed error activity class, or the default error activity if not found
     */
    private static Class<? extends Activity> guessErrorActivityClass(Context context,Class mErrorClass) {
        Class<? extends Activity> resolvedActivityClass;
        ...
        //Else, get the default launcher activity
        if (resolvedActivityClass == null) {
            resolvedActivityClass = mErrorClass;
        }
